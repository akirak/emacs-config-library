...
(define-abbrev-table 'direnv-envrc-mode-abbrev-table '())
...
(define-abbrev-table 'elm-compilation-mode-abbrev-table '())
...
(define-abbrev-table 'frame-workflow-editor-mode-abbrev-table '())
...
(define-abbrev-table 'jest-mode-abbrev-table '())

(define-abbrev-table 'js-comint-mode-abbrev-table '())
...
(define-abbrev-table 'nim-mode-abbrev-table '())

(define-abbrev-table 'nimscript-mode-abbrev-table '())
...
(define-abbrev-table 'trashed-mode-abbrev-table '())

(define-abbrev-table 'url-cookie-mode-abbrev-table '())

(define-abbrev-table 'use-package-statistics-mode-abbrev-table '())

(define-abbrev-table 'vbscript-mode-abbrev-table '())
...
(define-abbrev-table 'visual-basic-mode-abbrev-table
  '(
    ...
    ("form" "Form" nil 0)
    ("format" "Format" nil 0)
    ("formatcurrency" "FormatCurrency" nil 0)
    ("formatdatetime" "FormatDateTime" nil 0)
    ("formatnumber" "FormatNumber" nil 0)
    ("formatpercent" "FormatPercent" nil 0)
    ("forms" "Forms" nil 0)
